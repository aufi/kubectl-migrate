...
import (
	...
	"github.com/konveyor/kubectl-migrate/cmd/apply"
	"github.com/konveyor/kubectl-migrate/cmd/convert"
	export "github.com/konveyor/kubectl-migrate/cmd/export"
	plugin_manager "github.com/konveyor/kubectl-migrate/cmd/plugin-manager"
	"github.com/konveyor/kubectl-migrate/cmd/runfn"
	skopeo_sync_gen "github.com/konveyor/kubectl-migrate/cmd/skopeo-sync-gen"
	transfer_pvc "github.com/konveyor/kubectl-migrate/cmd/transfer-pvc"
	"github.com/konveyor/kubectl-migrate/cmd/transform"
	tunnel_api "github.com/konveyor/kubectl-migrate/cmd/tunnel-api"
	"github.com/konveyor/kubectl-migrate/cmd/version"
