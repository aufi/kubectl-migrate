...
import (
	...
	"github.com/konveyor/kubectl-migrate/cmd/plugin-manager/add"
	"github.com/konveyor/kubectl-migrate/cmd/plugin-manager/list"
	"github.com/konveyor/kubectl-migrate/cmd/plugin-manager/remove"
